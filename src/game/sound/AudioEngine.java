...
public class AudioEngine {
	...
	public static void playSound(AudioSource source){
		listenerLocation = new Point2D.Double(listener.getBounds().getBounds().getCenterX(), listener.getBounds().getBounds().getCenterY());
		...
		//System.out.println("Volume: " + volume + " Pan: " + pan + " Distance: " + dist + " Distance log: " + Math.log10(dist) + " Vector: " + vector);
	}
}
