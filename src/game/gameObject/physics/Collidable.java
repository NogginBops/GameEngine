...
public interface Collidable extends Movable {
	...
	/**
	 * This method is called when the next {@link #update(long)} method call
	 * will cause this object to collide with another {@link Collidable} object.
	 * 
	 * @param collisionObject
	 *            the {@link Collidable} this object will collide with.
	 */
	...
	/**
	 * This method is called when the next {@link #update(long)} method call
	 * will cause this object to exit a collision.
	 * 
	 * @param collidedObject
	 *            the {@link Collidable} this object will stop colliding with
	 */
	 ...
	 * 
	 * @param collidedObject
	 *            the {@link Collidable} this object is noLongerColliding with.
	 */
