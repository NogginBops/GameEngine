...
public class Camera extends Painter implements Movable, UpdateListener, KeyListener {
	...
	/**
	 * Creates a instance of a Camera object with the specified location, width and height.
	 * 
	 * @param gameObjectHandeler
	 *            - The {@link GameObjectHandler} whose content the camera should render.
	 * @param x
	 *            - The start x-coordinate of the upper most corner of the camera.
	 * @param y
	 *            - The start x-coordinate of the upper most corner of the camera.
	 * @param width
	 ...
	 * @param bool - Whether or not the camera should receive keyboard input.
	 */
	 ...
	 * 
	 * <p>
	 * This methods only updates {@link #paintables} array when {@link GameObjectHandler#haveObjectsChanged() haveObjectsChanged} method returns true.
	 * </p>
	 */
	@Override
	...
	/**
	 * <p>A camera object is always at the top of the scene and thus has a value of <code>Integer.MAX_VALUE - 8</code>.</p>
	 * <p>The z-level is not <code>Integer.MAX_VALUE</code> but 8 less to leave room for other functionality;
	 */
	@Override
