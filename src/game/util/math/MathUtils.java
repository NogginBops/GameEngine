...
public final class MathUtils {
	 ...
	 * @return
	 */
	public static float clampRect(float value, float length, float min, float max) {
		if (value < min) {
			return min;
	...
	/**
	 * Returns a int -1, 0 or 1 if the <code>value</code> is either below min, in
	 * between min and max or if it is above max respectively.
	 * 
	 * @param value
	 * @param min
	 * @param max
	...
	/**
	 * Maps value from the range [min, max] to a new range [newMin, newMax]. <br>
	 * <br>
